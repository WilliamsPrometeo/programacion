...
El objetivo principal es **integrar todo lo aprendido** hasta ahora: ejemplos_clase.clases, objetos, métodos, excepciones, colecciones y estructuras de control.
...
- Crear ejemplos_clase.clases con atributos, constructores y métodos bien estructurados.  
...
## 🧩 Estructura básica de las ejemplos_clase.clases
...
2. Implementa las ejemplos_clase.clases necesarias (Tienda y Videojuego).  
3. Crea un `ejemplos_clase.Main.java` con un menú que permita:
...
| **Uso de ejemplos_clase.clases y objetos** | Implementa correctamente las ejemplos_clase.clases `Videojuego` y `Tienda`. | 2 pts |
